  ...
  return (
    <div className="min-h-screen w-full flex bg-white text-ink font-sans selection:bg-accent selection:text-white">
      ...
      <div className="hidden md:flex md:w-[45%] bg-page relative flex-col justify-between p-12 lg:p-20 overflow-hidden">
        ...
        {/* Faint Watermark */}
        <div className="absolute inset-y-0 right-0 pointer-events-none select-none opacity-[0.02] font-serif text-[340px] leading-none tracking-tighter mix-blend-multiply flex items-center -mr-36">
          NEW
        </div>
      ...
      <div className="w-full md:w-[55%] bg-white relative flex flex-col p-8 sm:p-12 lg:p-20 md:shadow-[-4px_0_20px_rgba(0,0,0,0.04)] overflow-y-auto">
        ...
        <div className="w-full max-w-sm mx-auto flex-1 flex flex-col justify-center animate-fade-in-up" style={{ animationDelay: '0.2s', animationFillMode: 'both' }}>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="group relative animate-fade-in-up" style={{ animationDelay: '0.44s', animationFillMode: 'both' }}>
              <label className="block text-[12px] uppercase tracking-[0.08em] text-ink font-bold mb-2 transition-all duration-200 group-focus-within:-translate-y-[1px] group-focus-within:text-accent">
                Password
              </label>
              ...
              <div className="mt-2">
                <span className="text-[11px] text-[#8A8278]">min 8 characters</span>
              </div>
            </div>

            <div className="pt-2 animate-fade-in-up" style={{ animationDelay: '0.52s', animationFillMode: 'both' }}>
              <button
                type="submit"
                disabled={loading}
          ...
          <div className="mt-12 mb-8 text-[14px] text-[#8A8278] animate-fade-in" style={{ animationDelay: '0.6s', animationFillMode: 'both' }}>
            Already have an account?{' '}
            <Link href="/login" className="text-accent font-medium hover:underline underline-offset-4 decoration-accent/30 hover:decoration-accent transition-all">
              Log in
            </Link>
          </div>
